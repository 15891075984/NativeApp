 ...
 * @LastEditTime: 2020-05-10 14:27:34
...
<template>
    <div class="publish-list">
        <headerBar title="我卖出的"></headerBar>
        <div class="publish-item" v-for="(item) in mySellData" :key="item.id">
    ...
    mounted () {
        ...
        axios.get('/api/userSale').then(res => {
            ...
            this.mySellData.map(item=>{
                item.userHeaderPicture = item.icon
                item.sellerName = item.userName
            })
        })
    },
    computed:{
